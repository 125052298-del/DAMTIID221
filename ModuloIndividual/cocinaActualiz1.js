export class GestorInventarioCocina {
    ...
    // --- diferenciar productos por precio  ---

    // Obtiene productos con precio menor o igual al límite (Por defecto $80)
    obtenerProductosBaratos(limitePrecio = 80) {
        return this.inventario.filter(p => p.precio <= limitePrecio);
    }

    // Obtiene productos con precio mayor al límite (Por defecto $80)
